...
namespace FW.Common
{
    public class RabbitMQ2Helper
    {
        ...
        public RabbitMQ2Helper(string exchangeName, string queueName, string exchangeType, string routingKey, string userName, string password, string hostName, int port, string virtualHost)
        {
